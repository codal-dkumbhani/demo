	...
	class SPFTESTIMONIAL_Field_typography extends SPFTESTIMONIAL_Fields {
		...
		public function render() {
			...
			if ( ! empty( $args['font_size'] ) ) {
				...
				echo '<div class="spftestimonial--block"> <input disabled type="number" name="' . $this->field_name( '[font-size]' ) . '" class="spftestimonial--font-size spftestimonial--input spftestimonial-input-number" value="' . $this->value['font-size'] . '" /></div>';
			...
			if ( ! empty( $args['line_height'] ) ) {
				...
				// echo '<div class="spftestimonial--input-wrap">';
				echo '<div class="spftestimonial--blocks spftestimonial--input-area">';
				echo '<div class="spftestimonial--block"> <input disabled type="number" name="' . $this->field_name( '[line-height]' ) . '" class="spftestimonial--line-height spftestimonial--input spftestimonial-input-number" value="' . $this->value['line-height'] . '" /></div>';
				echo '<span class="spftestimonial--block spftestimonial--unit">' . $args['unit'] . '</span>';
				echo '</div>';
				echo '</div>';
			}
			...
			if ( ! empty( $args['letter_spacing'] ) ) {
				...
				// echo '<div class="spftestimonial--input-wrap">';
				echo '<div class="spftestimonial--blocks spftestimonial--input-area">';
				echo '<div class="spftestimonial--block"> <input disabled type="number" name="' . $this->field_name( '[letter-spacing]' ) . '" class="spftestimonial--letter-spacing spftestimonial--input spftestimonial-input-number" value="' . $this->value['letter-spacing'] . '" /></div>';
				echo '<span class="spftestimonial--block  spftestimonial--unit">' . $args['unit'] . '</span>';
				echo '</div>';
				echo '</div>';
			}
			...
			if ( ! empty( $args['word_spacing'] ) ) {
				...
				// echo '<div class="spftestimonial--input-wrap">';
				echo '<div class="spftestimonial--blocks spftestimonial--input-area">';
				echo '<div class="spftestimonial--block"><input disabled type="number" name="' . $this->field_name( '[word-spacing]' ) . '" class="spftestimonial--word-spacing spftestimonial--input spftestimonial-input-number" value="' . $this->value['word-spacing'] . '" /></div>';
				echo '<span class="spftestimonial--block spftestimonial--unit">' . $args['unit'] . '</span>';
				echo '</div>';
				echo '</div>';
			}
			...
			if ( ! empty( $args['margin_top'] ) ) {
				...
				echo '<div class="spftestimonial--blocks spftestimonial--input-area">';
				echo '<div class="spftestimonial--block"><input disabled type="number" name="' . $this->field_name( '[margin-top]' ) . '" class="spftestimonial--margin-top spftestimonial--input spftestimonial-number" value="' . $this->value['margin-top'] . '" /></div>';
			...
			if ( ! empty( $args['margin_right'] ) ) {
				...
				echo '<div class="spftestimonial--blocks spftestimonial--input-area">';
				echo '<div class="spftestimonial--block"><input disabled type="number" name="' . $this->field_name( '[margin-right]' ) . '" class="spftestimonial--margin-right spftestimonial--input spftestimonial-number" value="' . $this->value['margin-right'] . '" /></div>';
				echo '<div class="spftestimonial--block spftestimonial--unit">' . $args['unit'] . '</div>';
				echo '</div>';
				echo '</div>';
			}
			...
			if ( ! empty( $args['margin_bottom'] ) ) {
				...
				echo '<div class="spftestimonial--blocks spftestimonial--input-area">';
				echo '<div class="spftestimonial--block"><input disabled type="number" name="' . $this->field_name( '[margin-bottom]' ) . '" class="spftestimonial--margin-bottom spftestimonial--input spftestimonial-number" value="' . $this->value['margin-bottom'] . '" /></div>';
				echo '<div class="spftestimonial--block spftestimonial--unit">' . $args['unit'] . '</div>';
				echo '</div>';
				echo '</div>';
			}
			...
			if ( ! empty( $args['margin_left'] ) ) {
				...
				echo '<div class="spftestimonial--blocks spftestimonial--input-area">';
				echo '<div class="spftestimonial--block"><input disabled type="number" name="' . $this->field_name( '[margin-left]' ) . '" class="spftestimonial--margin-left spftestimonial--input spftestimonial-number" value="' . $this->value['margin-left'] . '" /></div>';
				echo '<div class="spftestimonial--block spftestimonial--unit">' . $args['unit'] . '</div>';
				echo '</div>';
				echo '</div>';
			}
