		...
		<div class="wrap about-wrap sp-tfree-help sp-tfree-upgrade">
			...
			<h2 class="sp-tfree-text-center sp-tfree-promo-video-title">Watch How <b>Testimonial Pro</b> Works</h2>
				...
				<div class="sp-tfree-join-community sp-tfree-text-center">
					...
					<a class="tfree-upgrade-btn" target="_blank" href="https://shapedplugin.com/plugin/testimonial-pro/?ref=1">Get a license instantly</a>
				...
				<div class="sp-tfree-upgrade-sticky-footer sp-tfree-text-center">
					...
					button-primary">Live Demo</a> <a href="https://shapedplugin.com/plugin/testimonial-pro/?ref=1" target="_blank" class="button button-primary">Upgrade Now</a></p>
				</div>
			</div>
		<?php
	}
...
This video playlist will help you get started with the plugin.',
				'testimonial-free'
			);
			?>
									</p>
