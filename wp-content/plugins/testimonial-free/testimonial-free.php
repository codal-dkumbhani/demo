		...
		public function add_plugin_action_links( $links, $file ) {
			...
			if ( SP_TFREE_BASENAME === $file ) {
				$ui_links        = array(
					...
					sprintf( '<a href="%s">%s</a>', admin_url( 'edit.php?post_type=sp_tfree_shortcodes' ), __( 'Manage Views', 'testimonial-free' ) ),
				);
				$links['go_pro'] = sprintf( '<a href="%s" style="%s">%s</a>', 'https://shapedplugin.com/plugin/testimonial-pro/?ref=1', 'color:#1dab87;font-weight:bold', __( 'Go Premium!', 'testimonial-free' ) );
